...
php5-curl php5-gd php-pear php5-mysql php5-mcrypt php5-xmlrpc php5-json php5-xsl dtrx haproxy supervisor \
...
RUN wget -q http://content.cms.i-evolve.net/logo_menu.png -O /var/www/concrete5.6.3.5/concrete/images/logo_menu.png
